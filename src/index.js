...
const stocks = [
    ...
    "APLLTD.NS", "AUROPHARMA.NS", "BIOCON.NS", "CIPLA.NS", "DIVISLAB.NS", "DRREDDY.NS", 
    "GLENMARK.NS", "GRANULES.NS", "LAURUSLABS.NS", "LUPIN.NS", "SUNPHARMA.NS", 
    ...
    "GUJGASLTD.NS", "IGL.NS", "MGL.NS", "CONCOR.NS", "CESC.NS", 
    "HUDCO.NS", "IRFC.NS", "ABBOTINDIA.NS", "BEL.NS", "CGPOWER.NS", 
    "CUMMINSIND.NS", "HAL.NS", "SIEMENS.NS", "TIINDIA.NS", "CHAMBLFERT.NS", 
    "COROMANDEL.NS", "GNFC.NS", "PIIND.NS", "BSE.NS", "DELHIVERY.NS", 
    "GMRAIRPORT.NS", "IRCTC.NS", "KEI.NS", "NAVINFLUOR.NS", "POLYCAB.NS", 
    "SUNTV.NS", "UPL.NS"
];
    ...
    try {
        ...
        for (const stock of stocks) {
            try {
                ...
                // Log the candles for debugging
                console.log(`Mother Candle for ${stock}:`, motherCandle);
                console.log(`Baby Candle for ${stock}:`, babyCandle);
                ...
                insideBars.push({
                    ...
                    babyCandle: {
                        ...
                        low: babyCandle.low // Ensure this is the low of the baby candle
                    },
                    prevDay: {
                        high: prevDayHigh,
                        low: prevDayLow
